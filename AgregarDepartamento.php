...
include ('include/cabecera.php');/*aqui llamaremos el archivo cabecera*/
...
?>
<div id="hola">
<div class="col-xs-8 col-sm-8 col-md-7 col-lg-7  col-xs-offset-2">
	<form name="form" action="AgregarDepartamentoo.php" method="POST">
		<br>
		<div class="panel panel-default panel-table">
			<div class="panel-heading"><h4 style="color: black" align="center">Departamento </h4></div>

			<div class="panel-body">
				<br>
				<div class="form-group col-xc-5" align="center">
					<label>Ingrese un Nuevo Departamento </label>
					<input type="text" name="Dep" id="Dep" class="form-control" placeholder="Ingrese Departamento" required>
					<br>
