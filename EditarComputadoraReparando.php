...
;
           ...
           echo " <select id='id_tipof' name='id_tipof' values=id_tipof class='form-control'>";
            	...
            	echo "<option value=".$mostrar['id_tipof']." ".$sel.">".$mostrar['tipodefalla']."</option>";
						...
						<div class='form-group'> 
						<label>Codigo:</label>
						<input type='text' value='$reg[3]' id='Codigo' name='Codigo' class='form-control' name='Codigo' placeholder='Ingrese El Codigo' maxlength='50' required readonly >
						</div>
						</div>";
...
echo "<div class='col-sm-3'>
         ...
         include 'connect.php';
         $tecc="SELECT * FROM login";
         $res=mysqli_query($con,$tecc);
...
echo "</select>
						...
						<label>Estatus:</label>";
						include 'connect.php';
						$es="SELECT * FROM estatus";
						$re=mysqli_query($con,$es);
           echo "<select name='id_estatus' id='id_estatus' class='form-control'>";
             while ($mostrar=mysqli_fetch_array($re)) {
             	$sel=0;
             	if ($mostrar[1]==$reg[9]) {
             		$sel='selected';
             	...
             	echo "<option value=".$mostrar['id_estatus']." ".$sel.">".$mostrar['Estatus']."</option>";
             }
